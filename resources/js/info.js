const info = {
    home: {
      ...
      info: `<p>This project is a very simple website using html5, css3 and vanilla javascript (~ES5), it contains information about the seven modern wonders of the world, and different showcases fo how to use specific html tags, css attributes and javascript selectors</p><br>`,
      points: [],
    ...
    tm: {
      ...
      points: [
        ...
        "This intricate work of art and architectural genius took 17 years to complete.",
    ...
    col: {
      ...
      points: [
        "Built between 72 AD and 80 AD, the Colosseum consists of stone and concrete. It was constructed by tens of thousands of enslaved Jews under the rule of the Emperor Vespasian.",
        "Measuring 189 metres long, 156 metres wide and 50 metres in height, the Colosseum is the largest amphitheater in the world.",
        "It’s estimated that over 400,000 people and over a million wild animals died during the centuries that the games took place."
      ],
    ...
    gwc: {
      ...
      points: [
        "With a total length of 21,196.18 km (13,170.70 miles), equal to half the length of the Equator, the Great Wall of China is the longest feat of human engineering.",
        "More than 1,000,000 laborers were recruited for the construction of this huge project.",
      ...
      moreinfo: 'https://en.wikipedia.org/wiki/Great_Wall_of_China',
    }
  }